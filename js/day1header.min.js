...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t}function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function removeSpinner(e){var t=document.querySelector("#"+e+" + .chart__spinner");t.parentNode.removeChild(t)}function doThisStuffOnScroll(){didScroll=!0}var _inView=require("in-view"),_inView2=_interopRequireDefault(_inView),_d=require("d3"),d3=_interopRequireWildcard(_d),_fairness=require("./fairness.js"),_fairness2=_interopRequireDefault(_fairness),pym=require("pym.js"),boot=require("bootstrap.js");NodeList.prototype[Symbol.iterator]=Array.prototype[Symbol.iterator],HTMLCollection.prototype[Symbol.iterator]=Array.prototype[Symbol.iterator];var didScroll=!1,mapBox=document.querySelector("#day1-header-display .map-wrapper").getBoundingClientRect();window.onscroll=doThisStuffOnScroll,setInterval(function(){if(didScroll){didScroll=!1;var e=document.querySelector("#day1-header-display"),t=e.getBoundingClientRect();mapBox.bottom>=t.bottom?document.querySelector("body").dataset.fixedMap=!1:document.querySelector("body").dataset.fixedMap=!0}},100),window.onload=function(){d3.json("http://apps.beta.tribapps.com/property-tax-assessments-map/data/tract-data2.geojson",function(e,t){new _fairness2.default({mapContainer:d3.select("#map"),data:t})}),(0,_inView2.default)(".text").on("enter",function(e){var t=document.querySelector(".text--visible");if(null!=t&&t.classList.remove("text--visible"),e.classList.add("text--visible"),d3.selectAll(".tract").classed("tract--highlight",!1),e.dataset.tractHighlight){var r=e.dataset.tractHighlight;d3.selectAll(".tract");d3.selectAll("."+r).classed("tract--highlight",!0)}});var e=document.querySelectorAll(".graphic-embed"),t=[],r=!0,o=!1,a=void 0;try{for(var i,n=e[Symbol.iterator]();!(r=(i=n.next()).done);r=!0){var l=i.value,d=l.id,s=l.dataset.iframeUrl,c=new pym.Parent(d,s,{});c.onMessage("childLoaded",removeSpinner(d)),t.push(c)}}catch(e){o=!0,a=e}finally{try{!r&&n.return&&n.return()}finally{if(o)throw a}}document.getElementById("mobile-nav-toggle").addEventListener("click",function(e){document.getElementById("nav-buttons-wrapper").classList.toggle("nav-buttons-wrapper--active")})};
},{"./fairness.js":2,"bootstrap.js":4,"d3":11,"in-view":12,"pym.js":13}],2:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t]);return r.default=e,r}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function mapScale(e){var r=(0,_getTribColors2.default)("trib-red2"),t=((0,_getTribColors2.default)("trib-gray4"),(0,_getTribColors2.default)("trib-blue4"));return e>1?r:e<1?t:1==e?"black":"yellow"}var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var a=r[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(r,t,a){return t&&e(r.prototype,t),a&&e(r,a),r}}(),_d=require("d3"),d3=_interopRequireWildcard(_d),_getTribColors=require("./getTribColors.js"),_getTribColors2=_interopRequireDefault(_getTribColors),queue=require("d3-queue").queue,Prerender=require("d3-pre"),prerender=Prerender(d3);NodeList.prototype[Symbol.iterator]=Array.prototype[Symbol.iterator],HTMLCollection.prototype[Symbol.iterator]=Array.prototype[Symbol.iterator];var CookCountyMap=function(){function e(r){_classCallCheck(this,e);var t=this;t.options=r,t.mapContainer=r.mapContainer,t.data=r.data,t.mapLayers=[{id:"chicago",url:"/data/chicago.geojson"},{id:"cook",url:"/data/cook-county.geojson"}];var a=queue();t.mapLayers.forEach(function(e){a.defer(d3.json,e.url)}),a.awaitAll(t.drawMap.bind(t))}return _createClass(e,[{key:"drawMap",value:function(){prerender.start();var e=this,r=e.mapContainer.node().getBoundingClientRect(),t=r.width,a=r.height,o=e.mapContainer.append("svg").attr("width",t).attr("height",a),n=d3.geoMercator().scale(1).translate([0,0]),i=d3.geoPath().projection(n),l=i.bounds(e.data),u=l[1][0]-l[0][0],c=l[1][1]-l[0][1],d=(l[0][0]+l[1][0])/2,s=(l[0][1]+l[1][1])/2,p=1/Math.max(u/t,c/a),f=[t/2-p*d,a/2-p*s-0];n.scale(p).translate(f),o.append("g").classed("tracts",!0).selectAll("path").data(e.data.features).enter().append("path").attr("data-name",function(e){return e.properties.NAME10}).attr("class",function(e){var r=e.properties.ratio1;return r>1?"tract tract--over":r<1?"tract tract--under":1==r?"tract tract--equal":"tract tract--none"}).attr("d",i)}}]),e}();module.exports=CookCountyMap;
},{"./getTribColors.js":3,"d3":11,"d3-pre":5,"d3-queue":10}],3:[function(require,module,exports){
"use strict";function getTribColor(r){return r=r.replace(/-/g,"_"),!!colors[r]&&colors[r]}var colors={trib_gray1:"#222",trib_grey1:"#222",trib_gray2:"#888",trib_grey2:"#888",trib_gray3:"#aaa",trib_grey3:"#aaa",trib_gray4:"#e0e0e0",trib_grey4:"#e0e0e0",trib_blue1:"#12182d",trib_blue2:"#004E87",trib_blue3:"#7493c1",trib_blue4:"#85b4d3",trib_blue5:"#cbdded",trib_red1:" #8C001A",trib_red2:" #C11B17",trib_red3:" #DE5454",trib_red4:" #eda398",trib_red5:" #f7d9d1",trib_orange:" #EB964F",trib_yellow1:" #f5f50a",trib_yellow2:" #ffff62",trib_yellow3:" #ffffc4",trib_yellow_green:" #D5D94D",trib_tan:" #EFE7DB",trib_green2:"#3a7f3b",trib_green3:"#4da84e",trib_green1:"#2e652f",trib_green4:"#71be72",trib_green5:"#b4ddb5",trib_violet:" #7E587E",trib_blue_gray:" #97ADBA",bears_blue:" #0B162A",bears_orange:" #C83803",cubs_blue:" #0E3386",cubs_red:" #CC3433",packers_green:" #2C5E4F",packers_gold:" #FFB612"};module.exports=getTribColor;
...
var dataString="data-pid",utils=require("./utils");module.exports=function(t){var e,n=t||-1,p=function(t){e=t};return{start:function(){var t=function(t){var p=t;t=utils.mapAppendName(e,t);var r=-1;return this.select(function(){if(n++,r===-1){var i=e.select(p+"["+dataString+'="'+n+'"]');r=i.empty()?1:0}if(1===r){var o=this.appendChild(t.apply(this,arguments));return e.select(o).attr(dataString,n).node()}return e.select("["+dataString+'="'+n+'"]').node()})};utils.isV4OrBetter(e)||(e.svg._axis=e.svg.axis,e.svg.axis=modifiedAxis(e),e.selection.enter.prototype._append=e.selection.enter.prototype.append,e.selection.enter.prototype.append=t),e.selection.prototype._append=e.selection.prototype.append,e.selection.prototype.append=t,e.selection.prototype._data=e.selection.prototype.data,e.selection.prototype.data=function(){if(!arguments.length)return this._data.apply(this,arguments);var t=this._data.apply(this,arguments);if(t.enter().empty()){var e=function(){return this};this.attr=e,this.style=e;var n=this;t.enter=function(){return n}}return t}},stop:function(){e.selection.prototype.append=e.selection.prototype._append,e.selection.prototype.data=e.selection.prototype._data,utils.isV4OrBetter(e)||(e.selection.enter.prototype.append=e.selection.enter.prototype._append,e.svg.axis=e.svg._axis)},setD3:p}};
},{"./utils":9}],7:[function(require,module,exports){
var browser=require("./browser"),preprocess=require("./preprocess");module.exports=function(r,e){e=e||{};var s=browser(),o=!1;return e.mode?"preprocess"===e.mode&&(s=preprocess(),o=!0):navigator.userAgent&&navigator.userAgent.indexOf("Electron")>-1&&(s=preprocess(),o=!0),s.setD3(r),{start:s.start,stop:s.stop,isPreprocessing:o}};
},{"./browser":6,"./preprocess":8}],8:[function(require,module,exports){
var utils=require("./utils");module.exports=function(t){var e,o=t||-1,p=function(){return this},n=function(t){e=t,e.selection.prototype._append=e.selection.prototype.append,e.selection.prototype._html=e.selection.prototype.html,e.selection.prototype._attr=e.selection.prototype.attr,e.selection.prototype._each=e.selection.prototype.each,e.selection.prototype.append=p,e.selection.prototype.html=p,e.selection.prototype.attr=p,e.selection.prototype.each=p,utils.isV4OrBetter(e)||(e.selection.enter.prototype._append=e.selection.enter.prototype.append,e.selection.enter.prototype.append=p)};return{start:function(){var t=function(t){var p=t;t=utils.mapAppendName(e,t);var n=-1,r=null,i=null;return this.select(function(){if(o++,n===-1){r=e.select(this);var l=r.select(p+'[data-pid="'+o+'"]');l.empty()?n=1:(n=0,i=r.select("*"))}if(1===n){var s=this.appendChild(t.apply(this,arguments));return e.select(s).attr("data-pid",o).node()}return 0===n?i[arguments[2]]:l})};e.selection.prototype.append=t,e.selection.prototype.html=e.selection.prototype._html,e.selection.prototype.attr=e.selection.prototype._attr,e.selection.prototype.each=e.selection.prototype._each,utils.isV4OrBetter(e)||(e.selection.enter.prototype.append=t)},stop:function(){utils.isV4OrBetter(e)||(e.selection.enter.prototype.append=p),e.selection.prototype.append=p,e.selection.prototype.html=p,e.selection.prototype.attr=p,e.selection.prototype.each=p},setD3:n}};
},{"./utils":9}],9:[function(require,module,exports){
var isV4OrBetter=function(e){return e.version&&+e.version.split(".")[0]>=4},d3_selection_creator=function(e,t){return"function"==typeof t?t:(t=e.ns.qualify(t)).local?function(){return this.ownerDocument.createElementNS(t.space,t.local)}:function(){return this.ownerDocument.createElementNS(this.namespaceURI,t)}},mapAppendName=function(e,t){return isV4OrBetter(e)?"function"==typeof t?t:e.creator(t):d3_selection_creator(e,t)};module.exports={isV4OrBetter:isV4OrBetter,mapAppendName:mapAppendName};
